...
export class FilesController {
    ...
    @ApiResponse({ status: 201, description: 'URL generated', schema: { example: { url: 'https://s3.amazonaws.com/...', key: 'uploads/file.jpg' } } })
    ...
    @ApiQuery({ name: 'key', type: String, required: true, example: 'uploads/file.jpg' })
    @ApiResponse({ status: 200, description: 'URL generated', schema: { example: { url: 'https://s3.amazonaws.com/...' } } })
