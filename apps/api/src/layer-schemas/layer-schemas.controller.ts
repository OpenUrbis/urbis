...
export class LayerSchemasController {
    ...
    @ApiResponse({ status: 200, description: 'List of layer schemas', type: [LayerSchema] })
    ...
    @ApiResponse({ status: 200, description: 'The layer schema', type: LayerSchema })
    ...
    @ApiResponse({ status: 201, description: 'The created layer schema', type: LayerSchema })
    ...
    @ApiResponse({ status: 200, description: 'The updated layer schema', type: LayerSchema })
    async update(@Param('id') id: string, @Body() dto: LayerSchemaDto): Promise<LayerSchema> {
    ...
    @ApiResponse({ status: 201, description: 'The created or updated layer schema', type: LayerSchema })
