...
| `light` | Cinza Claro | `Bases não oficiais` | `mapa` (Map 🗺️) | `/claro.jpg` | *N/A (Esri Light Gray)* |
| `dark` | Cinza Escuro | `Bases não oficiais` | `mapa` (Map 🗺️) | `/escuro.jpg` | *N/A (Esri Dark Gray)* |
| `outdoors` | Topográfico | `Bases não oficiais` | `mapa` (Map 🗺️) | `/topografico.jpg` | *N/A (OpenTopo)* |
| `satellite` | Satélite | `Bases não oficiais` | `satélite` (Satellite 🛰️) | `/satelite.jpg` | *N/A (Esri)* |
| `satellite-streets` | Satélite com ruas | `Bases não oficiais` | `satélite` (Satellite 🛰️) | `/hibrido.jpg` | *N/A (Esri + Carto)* |
