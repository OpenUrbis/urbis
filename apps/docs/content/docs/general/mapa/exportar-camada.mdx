...
É fundamental verificar e ajustar o Sistema de Referência de Coordenadas (SRC) da camada. Você pode conferir o SRC atual no canto inferior direito da janela do QGIS.
...
A partir desta etapa, iniciaremos a integração técnica. Para exportar ou gerenciar camadas, é necessário configurar a conexão com o banco de dados PostgreSQL/PostGIS.
...
![Preencher os dados de conexão](/Preencher%20os%20dados%20de%20conexão.png)
...
![Preencher os dados](/Preencher%20os%20dados.png)
