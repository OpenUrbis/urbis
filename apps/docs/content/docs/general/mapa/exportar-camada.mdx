...
![Preencher os dados de conexão](/export-layer-from-postgiz/Preencher%20os%20dados%20de%20conexão.png)
...
![Preencher os dados](/export-layer-from-postgiz/Preencher%20os%20dados.png)
