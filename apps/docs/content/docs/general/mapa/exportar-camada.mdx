...
![Baixar a camada](/export-layer-from-postgiz/baixar-a-camada.png)

### Criar Novo Projeto

Abra o QGIS e inicie um novo projeto.

![Crie um novo projeto](/export-layer-from-postgiz/crie-um-novo-projeto.png)
...
![Ajustar SRC](/export-layer-from-postgiz/ajustar-src.png)
...
![Ajustar SRC1](/export-layer-from-postgiz/ajustar-src1.png)
...
![Menu Postgres](/export-layer-from-postgiz/menu-postgres.png)

O menu para criar a conexão será exibido:

![Criar conexão postgres](/export-layer-from-postgiz/criar-conexao-postgres.png)
...
![Converter auth e testar](/export-layer-from-postgiz/converter-auth-e-testar.png)
...
![Abrir caixa de ferramentas](/export-layer-from-postgiz/abrir-caixa-de-ferramentas.png)

Na caixa de ferramentas, pesquise por "Export to PostgreSQL".

![Exportar para postgres](/export-layer-from-postgiz/exportar-para-postgres.png)
...
![Acessar tela de nova camada](/export-layer-from-postgiz/acessar-tela-de-nova-camada.png)
...
![Iniciar publicação da camada](/export-layer-from-postgiz/iniciar-publicacao-da-camada.png)
...
![Ajustar nome](/export-layer-from-postgiz/ajustar-nome.png)
...
![Conferencia dos dados](/export-layer-from-postgiz/conferencia-dos-dados.png)
