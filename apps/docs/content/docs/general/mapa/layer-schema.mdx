...
| `layerActions`   | Array de ações, essas ações serão renderizadas à direita da opção da camada                                | `[ { icon: 'info', action: "() => window.open('https://dadosabertos.urbis.sampa.br/','_blank')" } ]`                                                                                                                   |
