...
- **Documentação OpenAPI**: Consulte a especificação completa da API em [https://api.mapa.urbis.sampa.br/swagger/docs](https://api.mapa.urbis.sampa.br/swagger/docs) para mais detalhes sobre endpoints e parâmetros.
