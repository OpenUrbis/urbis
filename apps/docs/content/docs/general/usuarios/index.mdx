...
![Tela de cadastro](/Criar%20usuário/Tela%20de%20cadastro.png)
...
![Cadastrar usuário](/Criar%20usuário/Cadastrar%20usuário.png)
...
![Adicionar cargo](/Criar%20usuário/Adicionar%20cargo.png)
...
![Adicionar organização](/Criar%20usuário/Adicionar%20org.png)

No modal que se abre, selecione a organização e os cargos desejados:

![Modal de adicionar organização](/Criar%20usuário/Adicionar%20org%20modal.png)
...
![Remover organização](/Criar%20usuário/Remover%20Org.png)

### Alterar Permissões

É possível alterar os cargos de um usuário dentro de uma organização na seção **Organizações**.

![Alterar permissão do usuário na organização](/Criar%20usuário/Alterar%20permissão%20do%20usuário%20na%20org.png)

## Excluir Usuário

O usuário também pode ser excluído do sistema, caso necessário.

![Excluir usuário](/Criar%20usuário/Excluir%20usuário.png)
