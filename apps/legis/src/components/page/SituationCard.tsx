...
export function SituationCard({ group, defaultExpanded = false, onToggle }: SituationCardProps) {
    ...
    return (
        <div 
            ...
            className="bg-card border rounded-lg shadow-sm overflow-hidden transition-all hover:shadow-md mb-4 text-left"
        >
            {/* Header */}
            <div 
                className="bg-muted/30 p-2 border-b flex justify-between items-center cursor-pointer hover:bg-muted/50 transition-colors"
                ...
                <div className="p-2 space-y-2">
                    {group.situations.map((sit, idx) => (
                        <div key={idx} className="relative pl-2 border-l-2 border-muted">
                            ...
                            {sit.type === 'Veto' && (
                                <div className="text-[10px] bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 p-1.5 rounded mt-1 border border-red-100 dark:border-red-900/30">
                            ...
                            {sit.type === 'Derrubada de veto' && (
                                <div className="text-[10px] bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 p-1.5 rounded mt-1 border border-orange-100 dark:border-orange-900/30">
                            ...
                            {(sit.type === 'Nova redação' || sit.type === 'Alteração de ementa') && (
                                <div className="text-[10px] bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 p-1.5 rounded mt-1 border border-blue-100 dark:border-blue-900/30">
                            ...
                            {(sit.type === 'Perda definitiva de vigor/eficácia' || sit.type === 'Suspensão de vigor/eficácia') && (
                                <div className="text-[10px] bg-zinc-50 dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 p-1.5 rounded mt-1 border border-zinc-200 dark:border-zinc-800">
                                    <span className="font-bold text-[8px] uppercase block mb-0.5 opacity-70">
