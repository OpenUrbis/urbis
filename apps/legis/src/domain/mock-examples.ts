import {
  OriginalNormativo as NormativeOriginal,
  ColetaneaTematica,
} from "./types";
...
const LEI_PDE: NormativeOriginal = {
  ...
  editorContent: JSON.stringify({
    ...
    content: [
      {
        type: "paragraph",
        attrs: { normativeId: "pde_tit1" },
        content: [
          { type: "text", text: "TÍTULO I - DOS PRINCÍPIOS E DIRETRIZES" },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "pde_art1" },
        content: [
          {
            type: "text",
            text: "Art. 1º O Plano Diretor Estratégico do Município de São Paulo é o instrumento básico da política de desenvolvimento urbano e tem por objetivo ordenar o pleno desenvolvimento das funções sociais da cidade e da propriedade urbana.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "pde_art7" },
        content: [
          {
            type: "text",
            text: "Art. 7º São diretrizes da Política de Desenvolvimento Urbano:",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "pde_art7_inc1" },
        content: [
          {
            type: "text",
            text: "I - socialização dos ganhos da produção da cidade;",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "pde_art7_inc2" },
        content: [
          {
            type: "text",
            text: "II - priorização do transporte coletivo e dos modos não motorizados de locomoção;",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "pde_art8" },
        content: [
          {
            type: "text",
            text: "Art. 8º O detalhamento das zonas de uso será objeto da Lei de Parcelamento, Uso e Ocupação do Solo.",
          },
        ],
      },
    ],
    ...
    content: [
      {
        ...
        content: [
          {
            type: "text",
            text: "Art. 1º Esta lei disciplina o parcelamento, o uso e a ocupação do solo no Município de São Paulo, observadas as diretrizes do Plano Diretor Estratégico - PDE.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            text: "Art. 22. As zonas são porções do território onde incidem parâmetros de parcelamento, uso e ocupação do solo específicos.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            text: "Art. 23. As Zonas Exclusivamente Residenciais - ZER destinam-se à preservação da qualidade ambiental e urbanística de bairros estritamente residenciais.",
          },
        ],
      },
    ],
...
const LEI_COE: NormativeOriginal = {
  ...
  editorContent: JSON.stringify({
    ...
    content: [
      {
        type: "paragraph",
        attrs: { normativeId: "coe_art1" },
        content: [
          {
            type: "text",
            text: "Art. 1º Fica aprovado o Código de Obras e Edificações do Município de São Paulo, que disciplina as regras gerais a serem observadas no projeto, no licenciamento, na execução, na manutenção e na utilização de obras, edificações e equipamentos.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "coe_art15" },
        content: [
          {
            type: "text",
            text: "Art. 15. São de responsabilidade do proprietário a manutenção das condições de estabilidade, segurança e salubridade do imóvel.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "coe_art22" },
        content: [{ type: "text", text: "Art. 22. (VETADO)" }],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "coe_art55" },
        content: [
          {
            type: "text",
            text: "Art. 55. Para o licenciamento de edificações, deverão ser observados os índices urbanísticos estabelecidos na Lei de Parcelamento, Uso e Ocupação do Solo.",
          },
        ],
      },
    ],
...
const LEI_LPS: NormativeOriginal = {
  ...
  editorContent: JSON.stringify({
    ...
    content: [
      {
        type: "paragraph",
        attrs: { normativeId: "lps_art1" },
        content: [
          {
            type: "text",
            text: "Art. 1º O parcelamento do solo urbano poderá ser feito mediante loteamento ou desmembramento, observadas as disposições desta lei e das legislações estaduais e federais pertinentes.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "lps_art5" },
        content: [
          {
            type: "text",
            text: "Art. 5º Os loteamentos deverão atender aos requisitos urbanísticos de percentagem de áreas públicas, dimensões de lotes e sistema viário definidos no Plano Diretor.",
          },
        ],
      },
    ],
    ...
    content: [
      {
        ...
        content: [
          {
            type: "text",
            text: "Art. 1º Os parâmetros de ocupação do solo são definidos na tabela abaixo:",
          },
        ],
      },
      {
            ...
            content: [
              {
                ...
                content: [
                  {
                    type: "paragraph",
                    content: [{ type: "text", text: "Zonas Eixo" }],
                  },
                ],
              },
              {
...
const LEI_POSTURAS: NormativeOriginal = {
  ...
  editorContent: JSON.stringify({
    ...
    content: [
      {
        type: "paragraph",
        attrs: { normativeId: "post_art1" },
        content: [
          {
            type: "text",
            text: "Art. 1º Fica proibida a colocação de anúncio indicativo ou publicitário na paisagem urbana do Município de São Paulo.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "post_art2" },
        content: [
          {
            type: "text",
            text: "Art. 2º Para os fins desta lei, considera-se paisagem urbana o espaco aéreo e a superfície externa de qualquer elemento natural ou construído.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "post_art15" },
        content: [
          {
            type: "text",
            text: "Art. 15. As infrações às normas desta lei sujeitarão os infratores às penalidades de multa e remoção do anúncio.",
          },
        ],
      },
    ],
...
const LEI_DIVERSOS: NormativeOriginal = {
  ...
  editorContent: JSON.stringify({
    ...
    content: [
      {
        type: "paragraph",
        attrs: { normativeId: "cap_1" },
        content: [{ type: "text", text: "CAPÍTULO 1 - INTRODUÇÃO" }],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "art_1_antigo" },
        content: [
          {
            type: "text",
            text: "Art. 1º Nas ruas em que a Camara mandar fazer esgotos de pedras, ou concertar os existentes, são os proprietarios obrigados a calçar as suas testadas com pedras, dos mesmos esgotos para dentro.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "art_2_antigo" },
        content: [
          {
            type: "text",
            text: "Art. 2º Nas ruas em que a Camara mandar collocar ao lado dos esgotos guias de cantaria, são os proprietarios obrigados a calçar as suas testadas, das ditas guias para dentro, com lages de cantaria.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "art_3_antigo" },
        content: [
          {
            type: "text",
            text: "Art. 3º Fica marcado aos proprietarios o prazo de tres mezes, a contar da data em que terminar o concerto das ruas, para cumprirem a obrigação imposta nos artigos, antecedentes.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "art_4_antigo" },
        content: [
          {
            type: "text",
            text: "Art. 4º Os proprietarios que, findo o prazo, não tiverem feito o calçamento que lhes incumbe, ficão obrigados a satisfazer a despeza que com esse calçamento fizer a Camara, e mais a pagar a multa de 30$, para os cofres da Camara.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "fig_88" },
        content: [
          {
            type: "text",
            text: "Figura 88 - Faixas de uso da calçada - Corte",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "mapa_apa" },
        content: [{ type: "text", text: "APA BORORÉ-COLÔNIA - DELIMITAÇÃO" }],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "anexo_1" },
        content: [{ type: "text", text: "Anexo 1" }],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "nota_1" },
        content: [
          { type: "text", text: "(1) - Exceto para Zonas de Expansão." },
        ],
      },
    ],
  }),
  elements: [
    ...
    },
    {
      ...
      mapData: {
        files: [
          {
            name: "Anexo da Lei (PDF)",
            url: "https://legislacao.prefeitura.sp.gov.br/leis/lei-14162-de-24-de-maio-de-2006/anexo/62db2e651411921e64641188/Anexo%20%C3%BAnico%20da%20Lei%20n%C2%BA%2014.162_2006.pdf",
          },
        ],
        screen: {
    ...
    },
    {
      ...
      originalStartValidity: defaultValidity,
      specialSituations: [],
      noteData: [{ targetElementId: "anexo_1" }],
    },
  ],
  sources: [],
  createdAt: new Date().toISOString(),
...
const LEI_SITUACOES_ESPECIAIS: NormativeOriginal = {
  ...
  editorContent: JSON.stringify({
    ...
    content: [
      {
        type: "paragraph",
        attrs: { normativeId: "se_art1" },
        content: [
          {
            type: "text",
            text: "Art. 1º Este artigo exemplifica uma vigência inicial alterada (adiada).",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "se_art2" },
        content: [
          {
            type: "text",
            text: "Art. 2º Este artigo exemplifica um veto parcial de trecho.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "se_art3" },
        content: [
          {
            type: "text",
            text: "Art. 3º Este artigo exemplifica uma derrubada de veto.",
          },
        ],
      },
      {
        type: "paragraph",
        attrs: { normativeId: "se_art4" },
        content: [
          {
            type: "text",
            text: "Art. 4º Este artigo exemplifica uma renumeração.",
          },
        ],
      },
    ],
  ...
  alteracoesEmenta: [
    {
      ...
      newText:
        "Dispõe sobre a identificação de imóveis e sistemas de coordenadas geográficas do Município.",
...
const COL_USO_SOLO: ColetaneaTematica = {
  ...
  shortDescription:
    "Compêndio contendo os principais parâmetros de ocupação e zoneamento.",
    ...
    content: [
      {
        type: "heading",
        attrs: { level: 2 },
        content: [{ type: "text", text: "Regras Gerais de Zoneamento" }],
      },
      {
        type: "paragraph",
        content: [
          {
            type: "text",
            text: "O ordenamento territorial é a base para o desenvolvimento sustentável da cidade.",
          },
        ],
      },
    ],
...
const COL_HISTORICA_COMPLETA: ColetaneaTematica = {
  ...
  shortDescription:
    "Uma coletânea que abrange desde normas históricas de calçamento até parâmetros modernos de ocupação e representação gráfica.",
  fullDescription: JSON.stringify({
    type: "doc",
    content: [
      {
        type: "heading",
        attrs: { level: 1 },
        content: [{ type: "text", text: "Documentação Integrada" }],
      },
      {
        type: "paragraph",
        content: [
          {
            type: "text",
            text: "Esta coletânea agrupa elementos cruciais para entender a infraestrutura urbana.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            text: "Abaixo, a representação gráfica das calçadas:",
          },
        ],
      },
      {
      ...
      },
      {
        type: "paragraph",
        content: [
          { type: "text", text: "E os dados de zoneamento consolidados:" },
        ],
      },
      {
        type: "reference",
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            text: "Por fim, a delimitação da APA Bororé-Colônia:",
          },
        ],
      },
      {
