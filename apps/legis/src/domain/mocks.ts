...
export const MOCK_FULL_EXAMPLE: OriginalNormativo = {
  ...
  ementa:
    "Dispõe sobre a validação completa de todos os estilos de visualização de documentos normativos, incluindo tabelas complexas, figuras, mapas e notas de rodapé.",
  preamble:
    "<p><strong>O PREFEITO DO MUNICÍPIO DE SÃO PAULO</strong>, no uso das atribuições que lhe são conferidas por lei, faz saber que a Câmara Municipal, em sessão de 31 de dezembro de 2023, decretou e eu promulgo a seguinte Lei:</p>",
  signature:
    "<p>PREFEITURA DO MUNICÍMIR DE SÃO PAULO, aos 01 de janeiro de 2024, 471º da fundação de São Paulo.</p><p>RICARDO NUNES, Prefeito</p><p>FABRICIO COBRA ARBEX, Secretário Municipal da Casa Civil</p>",
  elements: [
    {
      id: "tit1",
      type: "Título",
  ...
  sources: [{ name: "Diário Oficial", url: "https://diariooficial.sp.gov.br" }],
...
export const MOCK_LEI_18080: OriginalNormativo = {
  ...
  authorityId: "pref-sp",
  ementa:
    "Institui, a partir do sistema de coordenadas geográficas, a possibilidade de fixação de placas para a identificação de imóveis que não possuam CODLOG e Código de Endereçamento Postal (CEP).",
  elements: [
    {
      id: "art1",
      type: "Artigo",
