export default function GuiaFiscalizacaoUrbanistica() {
  return (
      ...
      <main className="flex-1 p-4 max-w-[900px] mx-auto w-full space-y-8 pb-12">
        <section className="bg-card p-6 rounded-lg shadow-sm border border-border">
          <p className="mb-0 text-card-foreground">
            Abaixo, estão disponíveis fontes de consulta sobre documentos de
            controle urbanístico e cadastros auxiliares:
          </p>
        </section>
        ...
        <section className="bg-card p-6 rounded-lg shadow-sm border border-border">
            ...
            <li>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                ...
                <li>
                  ...
                  (nas camadas Licenciamento e Licenciamento Ambiental, e também
                  em Pesquisar {">"} Licenciamento)
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    className="text-blue-600 underline hover:text-blue-700 font-semibold"
                  >
                    Relação das Empresas Conservadoras de aparelhos de
                    transporte mecânico
                  </a>{" "}
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                ...
                <li>
                  <a
                    ...
                    className="text-blue-600 underline hover:text-blue-700 font-semibold"
                  >
                    Documentos emitidos pela Plataforma de Regularização de
                    Edificações (“Portal de Licenciamento”)
                  </a>
                </li>
                <li>
                  <a
          ...
          <ul className="list-disc pl-6 space-y-4 text-muted-foreground">
            ...
            <li>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>
                  Guarda Civil Metropolitana - Inspetoria de Defesa Ambiental -
                  IDAM (
                  <a
            ...
            <li>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>
                  <strong className="text-foreground">PROCON Paulistano</strong>{" "}
                  (Largo Páteo do Colégio, nº 5, Sé{" "}
                  <a
          ...
          <ul className="list-disc pl-6 space-y-3 text-muted-foreground">
            <li>
              <strong className="text-foreground">
                Os processos municipais possuem vários padrões de numeração
                diferentes:
              </strong>
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>
                  1. antes de 1978, os processos eram numerados em uma sequência
                  numérica seguida do ano (ex.: 99.999/51, para um processo de
                  1951);
                </li>
                <li>
                  2. entre 1978 e 1997, o padrão 99-999.999-78*99 (número de
                  etiqueta, para um processo de 1978);
                </li>
                <li>
                  3. entre 1997 até hoje (sendo progressivamente substituído
                  pelo SEI desde 2015), o padrão 1997-9.999.999-9 (Sistema
                  Municipal de Processos - SIMPROC, para um processo de 1997); a
                  depender da fonte pesquisada, pode aparecer como
                  1997-9999999-9, 0000/1997-9.999.999-9 ou
                  0000-1997-9.999.999-9;
                </li>
                <li>
                  4. após 2015, o padrão 9999/2015-9.999.999-9 (Sistema
                  Eletrônico de Informações - SEI, para um processo de 2015); a
                  depender da fonte pesquisada, pode aparecer como
                  9999/2015-9999999-9.
                </li>
              </ul>
            ...
            <li>
              Além dos números de processo, sistemas como o SLC, SLCe, Portal de
              Regularização e Aprova Digital se utilizam de números de protocolo
              para diferenciar os pedidos iniciais dos pedidos recursais, no
              padrão 9999-12 (para um processo de 2012); alguns pedidos possuem
              apenas esse número para busca (ex.: as Comunicações de Obra
              Emergencial, no SLCe); o Aprova Digital possui um número interno
              (às vezes também chamado de nº de protocolo) que contém números e
              letras (ex.: 99999-20-SP-ABC, para um processo de 2020).
            </li>

            <li>
              Os números de documento também variam com o tempo e com o sistema.
              Os mais recentes utilizam uma numeração sequencial finalizada em
              um dígito para a versão (ex.: 2012/1234-00 para o documento
              inicial de 2012, e 2012/1234-01 para um primeiro apostilamento -
              mesmo que não em 2012). No Aprova Digital, o número do documento é
              o seu número interno, e suas versões são informadas dentro do
              documento.
            </li>

            <li>
              O Diário Oficial da Cidade - DOC (antes do Decreto nº 46.195, de
              10 de Agosto de 2005, chamado Diário Oficial do Município - DOM)
              está disponível online:
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>
                  1. entre 02.12.1975 e 31.08.2001, na versão escaneada e com
                  reconhecimento óptico de caracteres (OCR), no Diário Oficial
                  antigo;
                </li>
                <li>
                  2. entre 01.09.2001 e 28.02.2023, na versão digital, no Diário
                  Oficial antigo;
                </li>
                <li>
                  3. a partir de 01.03.2023, na versão digital, no Diário
                  Oficial novo.
                </li>
              </ul>
            </li>
            ...
            <li>
              É possível solicitar uma pesquisa sobre a existência de processos
              e desarquivamento (planta/alvarás) de processos físicos arquivados
              pelo{" "}
              <a
              ...
              {">"} Processo físico arquivado - Pesquisa de existência de
              processos e desarquivamento (Planta/Alvarás).
            </li>

            <li>
              Na página Consulta de Processos, podem estar disponíveis mais
              informações sobre comunicações (Comunique-ses) ou decisões
              (Despachos).
            </li>

            <li>
              No SEI, caso a pessoa se configure como interessada em documentos
              que estejam com aceso restrito, tem o direito a vistas, que podem
              ser solicitadas pelo{" "}
              <a
                href="https://processos.prefeitura.sp.gov.br/Forms/PedidoEletronico1.aspx"
                target="_blank"
                rel="noopener noreferrer"
