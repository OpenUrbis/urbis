      ...
      <main className="flex-1 p-4 max-w-[900px] mx-auto w-full space-y-8 pb-12">
        <section className="bg-card p-6 rounded-lg shadow-sm border border-border">
          <p className="mb-4 text-card-foreground">
            <strong>As principais normativas urbanísticas do município são:</strong>
          </p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <li>
              <a
                ...
                className="text-blue-600 underline hover:text-blue-700 font-semibold"
              >
                <strong>Lei de Parcelamento, Uso e Ocupação do Solo - LPUOS</strong>
              </a>
            </li>
            <li>
              <a
        ...
        <section className="bg-card p-6 rounded-lg shadow-sm border border-border">
          ...
          <ul className="list-disc pl-6 space-y-3 text-muted-foreground">
            <li>
              ...
              :&nbsp;(Prefeitura) (mais completa fonte para pesquisas, apresentando dados de assinatura, publicação,
              situação, regulamentações, revogações, normas relacionadas, vetos e temas relacionados, além de em sua
              apresentação possuir links e versões consolidadas - que permite ver os conteúdos alterados - ou
              compiladas; entretanto, nem todo o seu conteúdo está digitalizado);
            </li>
            <li>
              <a
              ...
              :&nbsp;(Câmara de Vereadores) (possui todos os Projetos de Lei, Leis (e equivalentes) e Decretos, mas em
              geral digitalizados e sem reconhecimento óptico de caracteres - OCR);
            </li>
            <li>
              <a
              ...
              :&nbsp;(possui diversos materiais ilustrativos sobre as principais leis urbanísticas, além de mapas de lei
              em diversos formatos digitais, mas não possui estes materiais para as revisões destas normativas);
            </li>
            <li>
              <a
              ...
              {' > '}Busca Avançada{' > '}Diário Oficial da Cidade de SP (entre 12.1975 e 08.2001, versão escaneada e
              com reconhecimento óptico de caracteres - OCR; entre 09.2001 e 02.2023, versão digital);
            </li>
            <li>
              <a
            ...
            <li>
              ...
              &nbsp;{' > '}Legislação (algumas normas possuem apenas versão compilada, ou seja, não é possível ver os
              conteúdos alterados)
            </li>
            <li>
              <a
              ...
              :{' > '}Pesquisa Avançada{' > '}Data{' > '}Personalizado{' > '}Preencher a mesma data nos campos Início e
              Fim (ATENÇÃO: a mesma Seção pode possuir dois Cadernos, o Convencional - ex.: “nº 62” - ou Eletrônico -
              ex.: “nº 62-E”)
            </li>
            <li>
              <a
              ...
              <ul className="list-disc pl-6 mt-1 space-y-1">
                <li>
                  <a
                    ...
                    className="text-blue-600 underline hover:text-blue-700 font-semibold"
                  >
                    <strong>Bens tombados pelo IPHAN no Município de São Paulo</strong>
                  </a>
                </li>
                <li>
                  <a
