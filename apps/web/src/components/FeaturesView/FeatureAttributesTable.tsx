...
export const GLOBAL_ATTRIBUTE_LABELS_DE_PARA: Record<string, string> = {
  ...
  tipo_lote_fiscal: "Tipo de Lote",
  cd_tipo_quadra: "Tipo de Quadra",
  tipo_quadra: "Tipo de Quadra",
  tx_tipo_quadra: "Tipo de Quadra",
  tipo_quadra_fiscal: "Tipo de Quadra",
  tipo_uso_fiscal: "Tipo de Uso",
  implantacao_quadra: "Implantação na Quadra",
  cadastro_imobiliario_brasileiro_cib: "CIB",
  situacao_cadastro_imobiliario_brasileiro_cib: "Situação do CIB",
  ...
  qt_area_terreno: "Área do Terreno",
  ...
  qt_area_construida: "Área Construída",
    ...
    >
      ...
      >
        <span>
          ...
          {showAdvanced && " · Modo avançado ativo"}
        </span>
