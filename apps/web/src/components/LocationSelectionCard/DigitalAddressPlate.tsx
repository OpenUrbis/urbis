...
export const DigitalAddressPlate = ({ address, prefix, code }: DigitalAddressPlateProps) => {
    return (
        <div className="flex flex-col items-center gap-3 w-full">
            <div id="digital-address-plate" className="relative w-full aspect-[297/210] bg-[#003399] rounded-2xl print:rounded-none overflow-hidden shadow-xl border-2 border-white/10 flex flex-col p-6 items-center justify-between">
