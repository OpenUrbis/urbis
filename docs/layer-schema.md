...
| `layerActions`   | Array of action, this actions will be render in right of the layer option                                                | `[ { icon: 'info', action: "() => window.open('https://dadosabertos.urbis.sampa.br/','_blank')" } ]`                                                                                                                   |
| `maxZoom`        | Maximum zoom level for the Layer to be displayed (or `null` for no limit).                                               | `18`                                                                                                                                                                                                                   |
| `getText`        | Javascript function that receives the polygon object and must return a string that will be displayed inside the polygon. | `(d) => d.proprierties.name`                                                                                                                                                                                           |
| `minZoomText`    | Minimum zoom level for the Text to be displayed (or `null` for no limit).                                                | `17`                                                                                                                                                                                                                   |
| `maxZoomText`    | Maximum zoom level for the Text to be displayed (or `null` for no limit).                                                | `10`                                                                                                                                                                                                                   |
