  ...
  const handlePrepare = () => {
    ...
    if (serviceType.value === "WMS") {
      ...
      newLayer = {
        id: `wfs-${Date.now()}`,
        name: layerInfo?.title || selectedLayer.value,
        origin: `${baseUrl}?service=WFS&version=1.0.0&request=GetFeature&typeName=${encodeURIComponent(selectedLayer.value)}&maxFeatures=10000&outputFormat=json&srsName=CRS:84`,
        isActive: true,
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <Button
          ...
          className="h-8 w-8"
        >
          <UrbisIcon name="arrow_back" className="" aria-hidden="true" />
        </Button>
        ...
        <div className="grid w-full gap-4">
          ...
          {serviceType.value === "WFS" && (
            ...
            >
              ...
              <p>
                O serviço WFS carrega todos os dados vetoriais no navegador, o
                que pode causar lentidão ou travamentos em camadas com muitos
                elementos. Use com cautela ou prefira WMS para visualização.
              </p>
            </div>
          )}
      ...
      <div className="flex justify-end gap-2 pt-4">
        ...
        {!pendingSchema.value ? (
          <Button
            ...
            disabled={!selectedLayer.value || !selectedGroupId.value}
          >
            Próximo
          </Button>
        ) : (
