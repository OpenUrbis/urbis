      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-base text-muted-foreground pt-2">
            {mode.value === "select"
              ? "Adicione camadas personalizadas ao seu mapa de forma rápida. Estas camadas são temporárias e ficam disponíveis apenas durante a sua sessão atual."
              : mode.value === "web"
                ? "Conecte-se a serviços externos via WMS ou WFS para visualizar dados geográficos em tempo real."
                : "Envie arquivos geográficos diretamente do seu computador (máx. 400MB)."}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-4 py-6">
            ...
            >
              <div className="bg-green-100 dark:bg-green-900/30 p-4 rounded-full group-hover:scale-110 transition-transform">
                <span
                  className="h-10 w-10 text-green-600 dark:text-green-400 shrink-0"
                  style={{
