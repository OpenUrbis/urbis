...
export function SearchContainer({ moduleData }: SearchContainerProps) {
  ...
  return (
    <div className="flex h-full w-full bg-white overflow-hidden text-foreground">
      {/* Sidebar */}
        ...
        <ScrollArea className="flex-1 w-full">
          <div className="px-4 pt-4 pb-1 shrink-0">
            ...
            <p className="text-[11px]   leading-snug font-normal">
              Encontre usos permitidos por CNAE ou descrição, visualize zonas e
              notas da LPUOS. Descubra a permissibilidade do seu negócio por
              cores no mapa.
            </p>
          </div>
            ...
            <section className="mt-2 mb-4 space-y-4">
              <div className="flex items-center justify-between">
                <HeaderWithInfo
                  ...
                  link="https://legis.urbis.prefeitura.sp.gov.br/"
                />
                {state.selectedUse && (
                  <button
                ...
                <div className="space-y-6">
                  <div className="px-1.5 pt-1">
                    <LocalSlider
                      ...
                      step={1}
                      defaultValue={state.areaImovel || [0, AREA_MAX_DEFAULT]}
                      onValueCommit={(vals) =>
            ...
            <section className="mt-0 mb-4 space-y-4 border-t border-slate-100 dark:border-slate-800 pt-4">
              <div className="flex items-center justify-between">
                ...
                {Object.keys(state.urbanParams).length > 0 && (
                  <button
                    onClick={state.clearUrbanParams}
                    className="text-[10px] font-semibold text-primary hover:underline"
                  >
                    Limpar
                  </button>
            ...
            {state.synthesisMode ? (
                      ...
                      <div className="flex flex-wrap gap-2">
                        {compatibleZones
                          ...
                          .map((z) => (
                            <span
                              key={z}
                              className="bg-white dark:bg-slate-800 px-3 py-1.5 text-xs font-semibold shadow-sm border border-emerald-200 dark:border-emerald-800/60 text-emerald-800 dark:text-emerald-300 rounded-lg"
                            >
                              {z}
                            </span>
                          ))}
              ...
              <div className="flex flex-col items-center justify-center h-full w-full py-24 text-center animate-in fade-in duration-700">
                ...
                <p className="text-sm font-normal text-gray-500  max-w-[280px] leading-relaxed">
                  ...
                  viabilidade e parâmetros técnicos nesta zona.
                </p>
              </div>
            )}
          </div>
