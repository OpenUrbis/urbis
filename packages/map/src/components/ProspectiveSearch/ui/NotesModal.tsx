...
export function NotesModal({ notaId, isOpen, onClose }: NotesModalProps) {
  ...
  const content =
    NOTAS_DICTIONARY[cleanId] ||
    NOTAS_DICTIONARY[notaId] ||
    "Conteúdo da nota não encontrado na base de dados para esta referência.";

  return createPortal(
    <div className="fixed inset-0 z-[10050] flex items-center justify-center bg-black/20 backdrop-blur-sm animate-in fade-in duration-300 p-4">
