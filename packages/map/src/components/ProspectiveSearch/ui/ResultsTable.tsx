                ...
                {selectedUse && selectedUse.cnaeOriginario && (
                  <div className="space-y-2 pt-3">
                    ...
                    <p className="text-[11px] leading-relaxed text-muted-foreground font-normal">
                      ...
                      paulistana). Como consequência, as seguintes atividades da
                      lei paulistana podem ocorrer junto a qualquer CNAE:
                    </p>
                      ...
                      <table className="w-full text-left border-collapse text-[10px] leading-normal">
                        <thead>
                          <tr className="bg-muted dark:bg-slate-900 border-b border-border">
                            <th className="p-2 font-bold text-slate-700 dark:text-slate-300 w-1/4">
                              Atividade
                            </th>
                            <th className="p-2 font-bold text-slate-700 dark:text-slate-300 w-3/4">
                              Descrição
                            </th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-border">
                          <tr>
                            <td className="p-2 font-mono text-slate-950 dark:text-slate-100">
                              nR1-4-1
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="p-2">
                              Escritórios em geral, incluindo espaços para
                              Locação de Uso Compartilhado e “Co-Working”
                            </td>
                          </tr>
                          <tr>
                            <td className="p-2 font-mono text-slate-950 dark:text-slate-100">
                          ...
                          <tr>
                            ...
                            <td className="p-2">
                              Estacionamento e garagens de veículos com até 40
                              vagas (inclusive no sistema de garagens
                          ...
                          <tr>
                            ...
                            <td className="p-2">
                              Estacionamento e garagens de veículos com mais de
                              40 e até 200 vagas de automóvel (inclusive no
                              sistema de garagens subterrâneas) admitindo em
                              conjunto serviços de lavagem de carros manual ou à
                              seco sem serviços automotivos
                            </td>
                          </tr>
                          <tr>
                            <td className="p-2 font-mono text-slate-950 dark:text-slate-100">
                          ...
                          <tr>
                            ...
                            <td className="p-2">
                              ...
                              vagas de automóvel (inclusive no sistema de
                              garagens subterrâneas) admitindo em conjunto
                              serviços de lavagem de carros manual ou à seco sem
