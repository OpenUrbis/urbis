 ...
 * alterar camadas já publicadas.
 *
 * A aplicação que consome este pacote precisa servir `pattern.png` e `pattern.json`
 * na raiz pública; os arquivos prontos estão em `@open-urbis/map/public/`.
 * No monorepo, os assets são gerados por `node apps/web/scripts/generate-pattern-atlas.mjs`.
 *
 ...
 * de forma errada. Ao regerar a imagem com novos padrões, incremente o valor aqui e no
 * CSS da aplicação host.
 */
