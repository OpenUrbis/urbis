 ...
 */
export function expandirPorTexto(s) {
    s = s.trim();
    let base;
    let dec;
    if (s.includes(".")) {
 ...
 */
export function converterDeBase27(codigoBase27) {
    let resultado = 0n;
    const base = BigInt(27);
 ...
 */
export function decode(digitalAddress) {
 ...
 */
export function getPolygon(digitalAddress) {
    const { latStr, lonStr } = parseDigitalAddress(digitalAddress);
 ...
 */
export function getAddressMetrics(digitalAddress) {
